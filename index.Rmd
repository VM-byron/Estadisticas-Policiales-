...
``````{r, Lectura del archivo, message=FALSE, echo=FALSE, warning=FALSE}  
estadisticas <-
...
```{r, Gráfico 1, message=FALSE, warning=FALSE} 
Grafics <-
  estadisticas %>%
  count(Delito) %>%
...
```{r, Gráfico 2, message=FALSE, warning=FALSE}  
Grafics_2 <-
...
``` {r, Grafico 4, message=FALSE, warning=FALSE} 
grafics_4 <-
  estadisticas %>%
  count(Cantón) %>%
